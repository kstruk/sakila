...
@Slf4j
public class V0_1_1012__CreateTableFilmText extends SimpleJooqMigration {
    ...
    protected String getSql() {
        return DSL.using(getDsl().dialect(), getDsl().settings())
            ...
            .column(name("title"), VARCHAR(128).notNull())
            .column(name("description"), VARCHAR(512).notNull())
